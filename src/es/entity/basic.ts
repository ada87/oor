import type { SqlDelete, SqlInsert, SqlOrderBy, SqlUpdate, SqlLimit, SqlSelect, SqlCount, SqlByField, PlainObject } from '../../base/sql';
...
export const insert: SqlInsert = (indexName: string, obj: any): [string, PlainObject] => [indexName, {
    index: indexName, op_type: 'create', document: obj,
}];

export const update: SqlUpdate = (indexName: string, obj: any, key = 'id'): [string, any] => {
